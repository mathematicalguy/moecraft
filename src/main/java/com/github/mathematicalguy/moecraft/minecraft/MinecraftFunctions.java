 ...
 * https://github.com/TheGreyGhost/MinecraftByExample/blob/master/src/main/java/minecraftbyexample/usefultools/UsefulFunctions.java
 *
 * Some presumably useful functions for mod development
 */
public abstract class MinecraftFunctions {
    private MinecraftFunctions() {
